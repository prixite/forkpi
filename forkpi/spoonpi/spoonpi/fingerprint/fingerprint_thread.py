...
class FingerprintThread(threading.Thread):
    def __init__(self, ForkpiDB):
        ...
        self.matches = (
            []
        )  # Keypair IDs whose fingerprint field matches the current finger

    def start_polling(self):
        self.is_polling = True
        self.finger_scanned = (
            False  # True if a finger has been scanned (not necessarily match)
        )
